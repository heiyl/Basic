package com.common.basic.Imagefinal.GlideConfig;
...
public class GlideUtils {
    ...
    public static File getTmpDir(Context context, boolean isSdcard) {
        ...
        if (sdCardExist || isSdcard) {
            tmpDir = new File(Environment.getExternalStorageDirectory() + Constant.BASIC_DIR_NAME,
                    getTmpDirName());
        } else {
            tmpDir = new File(context.getCacheDir() + Constant.BASIC_DIR_NAME, getTmpDirName());
        }
    ...
    public static String getTmpDirName() {
        return Constant.IMAGELOADER_CATCH_DIR_NAME;
    }
}
